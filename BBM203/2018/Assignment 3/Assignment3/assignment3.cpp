...
// Function to reads operations.txt file , creates output file , write necessary data
void read_operations_and_output(Node* head,string operations,string output){
    ...
    out << "2)GOAL SCORER\n";
    current = head;
    //calculate and write GOAL SCORER , checks with max goal var.
    while (current != NULL){
        Node2* current2 = current->MinAndMatch;
        int goal =0;
    ...
    // calculate footballer goal and detect and write who scored hat-trick
